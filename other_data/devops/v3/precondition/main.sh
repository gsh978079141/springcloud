...
kubectl create namespace edu-cloud-dev
kubectl create namespace edu-edge-dev
# 创建 docker-registry secret: harbor-secret
kubectl create secret docker-registry harbor-secret --docker-server=core.harbor.cz.shenlan.com --docker-username=dbp-edu --docker-password=D8jWTYOI2q -n edu-cloud-dev
kubectl create secret docker-registry harbor-secret --docker-server=core.harbor.cz.shenlan.com --docker-username=dbp-edu --docker-password=D8jWTYOI2q -n edu-edge-dev
