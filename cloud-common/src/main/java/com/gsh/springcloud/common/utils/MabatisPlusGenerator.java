 ...
 * @Package com.gsh.shoppingmall.utils
 * @Description:
 * @date 2018/9/6 16:44
 */
public class MabatisPlusGenerator {
     ...
     * 单个表名
     */
    private static String oneTable = "test";
...
//    private static String path = file.getAbsolutePath();
     ...
     * 代码生成绝对路径
     */
    private static String path = "/Users/gdd/Desktop/WorkSpaces/Github_Projects/springcloud/service-order";
    private static String entiyPath = "/Users/gdd/Desktop/WorkSpaces/Github_Projects/springcloud/cloud-common/src/main/java/entity/";
...
//                                 }
                ...
                new PackageConfig()
                        ...
                        // 自定义包路径
                        .setEntity(entiyPath)
                        .setParent("com.gsh.springcloud.order")
                        // 这里是控制器包名，默认 web
...
//                        this.setMap(map);
//                    }
//                }.setFileOutConfigList(Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/entity.java.vm") {
//                    // 自定义输出文件目录
//                    @Override
//                    public String outputFile(TableInfo tableInfo) {
//                        return entiyPath + tableInfo.getEntityName() + ".java";
//                    }
//                }))
//        )
                .setTemplate(
