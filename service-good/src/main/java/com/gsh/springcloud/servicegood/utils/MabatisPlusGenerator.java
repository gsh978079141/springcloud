package com.gsh.springcloud.servicegood.utils;
/**
...
import com.gsh.springcloud.serviceorder.utils.DatabaseUtil;
...
public class MabatisPlusGenerator {
     ...
     * 单个表名
     */
    private static String oneTable = "good";
     ...
     * 文件路径
     */
    private static String packageName = "service-good";
    /**
     * 作者
     */
